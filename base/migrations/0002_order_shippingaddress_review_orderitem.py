# Generated by Django 4.1.3 on 2023-01-11 01:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taxPrice', models.DecimalField(blank=True, decimal_places=7, max_digits=7, null=True)),
                ('shippingPrice', models.DecimalField(blank=True, decimal_places=7, max_digits=7, null=True)),
                ('totalPrice', models.DecimalField(blank=True, decimal_places=7, max_digits=7, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(blank=True, decimal_places=7, max_digits=7, null=True)),
